...
def logout_page():
    logout_user()
    flash("You have been successfully logged out of your Tendering System Account.",category='info')
...
def contact_page():
    ...
    if form.validate_on_submit():
        ...
        subject = f"Requesting Super-Admin privileges for Tender {tender_id} under Tendering System Listing."
        body = f"User query: {user_query}\n\nTender ID: {tender_id}\nThis is an auto-generated mail. Please revert back to the request at {user_email}.\nTendering System TMS."
...
def add_item():
    ...
    closing_date_str = request.json['closing_date']
